const aboutMeMinis = {
    ...
    mini5: { category: 'Experience ⚙️', title: 'Creative Tech Intern, Elephant / MAIP 2022 🐘', subtitle: 'June 2022 - August 2022', skills: ['CMS integration, feature creation, and bug fixes for dozens of issues on company site', 'Prototyping Xfinity in-store experiential installations with BrightSign using BrightAuthor', 'Implementation of 3D graphics on React Website with Three.js utilizing React Three Fiber'] },
    mini6: { category: 'Experience ⚙️', title: 'Political Science Major, UCF 🦄', subtitle: '2018-2022', skills: ['Political Science Major, History Minor', 'CS & IT classes', 'Self-teaching webdev :p'] },
